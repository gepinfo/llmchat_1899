...
export const ORGDBURL = process.env.ORGDBURL;
export const DBCREDENTIALURL = process.env.DBCREDENTIALURL;
export const ROLEPERMISSIONURL = process.env.ROLEPERMISSIONURL;