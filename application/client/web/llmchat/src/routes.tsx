...
{ path : '/orgdb', component: lazy(()=>import('./app/orgdb/orgdb')) },
{ path : '/dbcredentials', component: lazy(()=>import('./app/dbcredentials/dbcredentials')) },
{ path : '/organization', component: lazy(()=>import('./app/organization/organization')) },
